...
// the brand without duplicating "— DockIt" in their own titles.
export const metadata = {
  metadataBase: new URL("https://lcbc-client.apps.johnseong.com"),
  title: {
    default: "DockIt — Free protein-ligand docking in your browser",
    template: "%s — DockIt",
  },
  description:
  ...
  keywords: [
    ...
    "structure-based drug design", "medicinal chemistry", "DockIt", "LCBC-Dock",
  ...
  openGraph: {
    ...
    siteName: "DockIt",
    title: "DockIt — Free protein-ligand docking in your browser",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "DockIt — molecular docking platform",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "DockIt — Free protein-ligand docking",
        ...
        <div className="min-h-screen bg-black text-white">
          <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-md border-b border-white/5">
            <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
              <Link href="/" className="flex items-center gap-2" aria-label="DockIt home">
