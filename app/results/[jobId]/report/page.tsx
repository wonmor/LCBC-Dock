      ...
      <div className="bg-white text-black min-h-screen">
        ...
        <article className="max-w-3xl mx-auto px-8 py-10 text-sm leading-relaxed">
          ...
          <header className="mb-8 pb-6 border-b border-gray-300">
            <p className="text-xs uppercase tracking-widest text-gray-500 mb-2">MolDock Lab Report</p>
          ...
          <section className="mb-6">
            ...
            <p>
              ...
              {" "}using AutoDock Vina via the MolDock platform. The lowest-energy pose
          ...
          <footer className="pt-6 border-t border-gray-300 text-xs text-gray-500">
            <p>
              Generated by <strong>MolDock</strong> · job submitted {createdAt}
            </p>
          </footer>
        </article>
      </div>
